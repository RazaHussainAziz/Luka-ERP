...
export function BaselineSpaceDashboard(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function SharpInventory(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <path
        fill="currentColor"
        d="M5 5h2v3h10V5h2v5h2V3h-6.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H3v18h8v-2H5zm7-2c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1"
      ></path>
      <path
        fill="currentColor"
...
export function AnalyticsOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
...
export function PersonWorker(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M3.5 9h7L7 3.5L3.5 9z"></path>
      </g>
    </svg>
  );
}
...
export function BoxClosed(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    ...
    >
      <path
        fill="currentColor"
        d="m256 42.667l192 106.666v213.334L256 469.333L64 362.667V149.333zM405.333 190.4l-128 73.899v143.914l128-73.637zm-298.666 1.195v143.006l128 73.612v-142.72zm69.12-55.531l-40.043 23.04l119.232 68.843l39.979-23.083zM256 89.947l-37.461 21.541l119.082 68.736l37.59-21.696z"
      ></path>
    </svg>
  );
}
...
export function UserAvatarOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
